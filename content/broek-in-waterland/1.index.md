...
navigation:
  ...
  description: 
seo:
  title: best things to doi in the Amsterdam countryside
  description:  The besty thing to do in the Amsterdam countryside is to visist Broek in Waterland, just outside Amsterdam - why you should skip Volendam and De Zaanse Schans and head to Broek in Waterland instead.
...
#footer
  ...
  [Plan your trip](https://maps.app.goo.gl/tmLbzzFtMY7yYMLC8)
  :::
::
...
There is a bug on the Studio editor parser, my initial content:
...
It has been modified the wrong way, here is the result:
